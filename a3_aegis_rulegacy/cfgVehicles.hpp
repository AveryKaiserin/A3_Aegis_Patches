...
class CfgVehicles
{
	...
	HEADGEAR_HOLDER(H_HelmetSpecter_cover_khaki_F,$STR_A3_O_CfgWeapons_H_HelmetSpecter_cover_khaki_F0,EdSubcat_Helmets)
	HEADGEAR_HOLDER(H_HelmetSpecter_cover_taiga_F,$STR_A3_O_CfgWeapons_H_HelmetSpecter_cover_taiga_F0,EdSubcat_Helmets)
};